                   ...
                   fluidRow(
                     ...
                     column(
                       ...
                       div(style = "display: flex; justify-content: flex-start; align-items: center;",
                           uiOutput("download_FormatttedForecasts_UI"))
                 ...
                 fluidRow(
                   ...
                   column(
                     ...
                     div(style = "display:flex; vertical-aline: top",
                         ...
                         div(uiOutput("download_quantile_forecasts_UI"), style = "margin-right:10px"),
                      ...
                      conditionalPanel(
                        ...
                        div(style = "display:flex; vertical-aline: top",
                            ...
                            div(style = "margin-right: 10px",
                                uiOutput("download_AvgMetrics_UI")),
                       ...
                       fluidRow(
                         ...
                         column( 
                           ...
                           div(style = "display:flex; vertical-aline: top",
                               ...
                               #######################################
                               div(uiOutput("downloadWinkerData_UI")),
                       ...
                       fluidRow(
                         ...
                         column( 
                           ...
                           div(style = "display:flex; vertical-aline: top",
                               ...
                               # Creating the download button - Data #
                               #######################################
                               div(style = "margin-right: 10px", uiOutput("downloadSSMetrics_UI")),
                   ...
                   fluidRow(
                     ...
                     column(
                       ...
                       div(style = "display:flex; vertical-aline: top",
                           ...
                           div(uiOutput("downloadAverageMetrics_UI")),
                   ...
                   fluidRow(
                     ...
                     column(
                       ...
                       div(style = "display:flex; vertical-aline: top",
                           ...
                           div(uiOutput("downloadCrudeMetrics_UI")),
                   ...
                   fluidRow(
                     ...
                     column(
                       ...
                       div(style = "display:flex; vertical-aline: top",
                           ...
                           div(style = "margin-right: 10px", uiOutput("downloadWinklerMetrics_UI")),
                   ...
                   fluidRow(
                     ...
                     column(
                       ...
                       div(style = "display:flex; vertical-aline: top",
                           ...
                           div(style = "margin-right: 10px", uiOutput("downloadSSMetricsOther_UI")),
...
server <- function(input, output, session) {
  ...
  # Dynamic rendering for all other download buttons
  observe({ output$download_FormatttedForecasts_UI <- renderUI({ downloadButton("download_FormatttedForecasts", "Download Forecast Data") }) })
  observe({ output$download_quantile_forecasts_UI  <- renderUI({ downloadButton("download_quantile_forecasts", "Download Quantile Forecasts") }) })
  observe({ output$download_AvgMetrics_UI          <- renderUI({ downloadButton("download_AvgMetrics", "Download Average Metrics") }) })
  observe({ output$download_metrics_UI             <- renderUI({ downloadButton("download_metrics", "Download Crude Metrics") }) })
  observe({ output$downloadWinkerData_UI           <- renderUI({ downloadButton("downloadWinkerData", "Download Scores", style = "margin-right: 10px") }) })
  observe({ output$downloadSSMetrics_UI            <- renderUI({ downloadButton("downloadSSMetrics", "Download Skill Scores") }) })
  observe({ output$downloadAverageMetrics_UI       <- renderUI({ downloadButton("downloadAverageMetrics", "Download Avg. Metrics", style = "margin-right: 10px") }) })
  observe({ output$downloadCrudeMetrics_UI         <- renderUI({ downloadButton("downloadCrudeMetrics", "Download Crude Metrics", style = "margin-right: 10px") }) })
  observe({ output$downloadWinklerMetrics_UI       <- renderUI({ downloadButton("downloadWinklerMetrics", "Download Winkler Scores") }) })
  observe({ output$downloadSSMetricsOther_UI       <- renderUI({ downloadButton("downloadSSMetricsOther", "Download Skill Scores") }) })
